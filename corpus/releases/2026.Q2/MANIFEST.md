...
| | |
|---|---|
| Date (UTC) | 2026-05-10T19:29:33Z |
| Tarball | `corpus-2026.Q2.tar.gz` |
| SHA-256 | `535260680fdd59f3bb14750a7ce79be3fbf026dd5b062d7876bc68c3631e522a` |
| Entries |      376 |
...
The exact byte sequence of `corpus-2026.Q2.tar.gz` (SHA-256 `535260680fdd59f3bb14750a7ce79be3fbf026dd5b062d7876bc68c3631e522a`)
...
The contents of that tarball — including `corpus.jsonl` with its
     376 entries — are therefore public disclosures as of those
