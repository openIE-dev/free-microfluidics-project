---
title: separation-membrane-filtration-on-chip
parent: Cross-cuts
layout: default
---
...
## Mott Corporation porous-metal microreactor inserts (GasShield, FlowMott) (2003)

- **id**: `mott-corporation-porous-metal-flow-reactor`
- **corpus**: private
- **device class**: mixer-component
- **creator**: Mott Corporation (Farmington, CT)
...
- **corpus**: private
- **device class**: separator-component
- **creator**: Asahi Kasei Medical Co., Ltd.
- **disclosure**: Asahi Kasei Medical Co., Ltd. Planova S20N launch 2018. Manabe, S. Removal of virus through novel membrane filtration method. Dev. Biol. Stand. 1996, 88:81-90 (parent technology). Patent family: US10046276B2 (Asahi Kasei; priority 2014).
- **ip status**: patented
- **prior art notes**: Discloses a 19 nm cuprammonium-cellulose hollow-fiber virus filter, originally developed for plasma-derived biotherapeutics, in a variant (S20N) validated for sustained continuous operation. Anticipates: (a) continuous-mode virus filtration in connected downstream trains; (b) cuprammonium-cellulose hollow-fiber membrane chemistry for parvovirus-grade filtration; (c) integration of viral-clearance steps into continuous biomanufacturing process trains for both mAb and CGT (e.g., AAV) workflows.
