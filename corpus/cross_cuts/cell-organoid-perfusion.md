...
## Cordwainer Smith Norstrilia Stroon longevity treatment (1964)

- **id**: `cordwainer-smith-stroon-treatment`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Cordwainer Smith (Paul Linebarger)
...
## Hainish Ekumen biological engineering and the ancestral seeding (Le Guin, Hainish Cycle) (1966-01-01)

- **id**: `le-guin-hainish-ekumen-bioengineering`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Ursula K. Le Guin
- **disclosure**: Ursula K. Le Guin, Rocannon's World (Ace, 1966) onward; the Hainish ancestral seeding of human worlds (including the engineered Gethenians) established in The Left Hand of Darkness (Ace, 1969) ISBN 978-0-441-47812-9; later medical biotech in Four Ways to Forgiveness (HarperPrism, 1995) ISBN 978-0-06-105234-5 and The Telling (Harcourt, 2000).
- **ip status**: fictional
- **prior art notes**: Discloses deliberate germline engineering of founder populations with deep-time consequence tracking, plus applied medical biotech distributed across many worlds. Anticipates generic claims to founder-population germline engineering programs and to long-horizon outcome-tracking of germline interventions. Borderline-fluidic; cited for completeness of the bioengineering-fiction map. Pairs with butler-oankali-bio-technology and cherryh-cyteen-azi-production.
...
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Denny O'Neil / Neal Adams / DC Comics
- **disclosure**: Batman #243 (DC Comics, August 1972), Denny O'Neil & Neal Adams; Lazarus Pit explicitly named Batman #244 (1972); appears across Batman, Robin, Red Hood, and Arrow comics 1971-present.
- **ip status**: fictional
- **prior art notes**: DC Lazarus Pit depicted as a chemical/mineral fluid pool that, on immersion of a deceased or dying body, restores life and youth. Visually depicted as a roiling green liquid-filled basin. Across DC continuity (and the Arrowverse adaptation) the Pit's chemistry is described as alchemical/biological. Defensive prior art (1971+) for: large-volume immersion-fluid resurrection chamber, mineral/chemical regenerative bath, and induced-regrowth fluidic apparatus. ~55-year cumulative depiction in major franchise.

## DC Cadmus Project cloning and genetic-engineering facility (1971)

- **id**: `dc-cadmus-project-cloning`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Jack Kirby / DC Comics
- **disclosure**: Superman's Pal, Jimmy Olsen #133-148 (DC, 1970-1972), Jack Kirby; reactivated Death of Superman / Reign of the Supermen (1992-1993) introducing Superboy clone.
- **ip status**: fictional
...
## Lazarus Pit resurrection chemistry (Ra's al Ghul, DC Comics) (1971-06-01)

- **id**: `dc-lazarus-pit-resurrection-chemistry`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: DC Comics; Dennis O'Neil & Neal Adams
- **disclosure**: Batman #232 (DC Comics, June 1971), written by Dennis O'Neil, art by Neal Adams -- introduction of Ra's al Ghul; the Lazarus Pit first shown in Batman #243-244 (August-September 1971); detailed in numerous later issues (e.g., Batman: Birth of the Demon, 1992).
- **ip status**: fictional
- **prior art notes**: Discloses a whole-body immersion-bath restorative with a documented post-treatment adverse window, sited at natural chemical confluences and (later) artificially reproducible. Anticipates generic claims to immersion-bath restorative therapies and to documented post-immersion adverse-state management. Borderline (magic-adjacent) but consistently framed as chemistry; pairs with dc-cadmus-clone-vats (below), bloodborne-healing-church-blood-ministration, and doctor-who-tardis-zero-room.
...
- **id**: `brin-startide-rising-medbay`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: David Brin
- **disclosure**: David Brin, Startide Rising (Bantam 1983) ISBN 0-553-23495-0; The Uplift War (1987).
- **ip status**: fictional
- **prior art notes**: Streaker's medical bay accommodates uplifted dolphin and human crews — separate hydration tanks, fin-anatomy surgical fixtures, and species-specific drug formulations. Defensive prior art for multi-species medical-bay architecture with species-specific bed/tank fixtures.
...
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Chris Claremont / Marvel Comics
...
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: FASA / Catalyst Game Labs
...
- **device class**: fictional-laboratory
- **creator**: Dan Simmons
- **disclosure**: Dan Simmons, Endymion (Bantam 1996) ISBN 0-553-10020-7; The Rise of Endymion (1997).
- **ip status**: fictional
- **prior art notes**: Pax Reactivation Centers depicted as standardized facilities (every Pax world has them) where deceased Cruciform-bearers are placed in nutrient/perfusion vats for ~3-day regeneration. Detailed depictions of multi-bed perfusion arrays, monitoring instrumentation, and standardized post-resurrection medical care. Architecturally anticipates: industrialized whole-body cell-culture / regrowth facilities, multi-bed perfusion arrays, and combined religious/medical institutional integration of biological technology.
...
## GURPS Bio-Tech sourcebook (Steve Jackson Games 1996) (1996)

- **id**: `gurps-bio-tech-sourcebook`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: David Pulver / Steve Jackson Games
...
- **id**: `stargate-asgard-bio-transfer`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Brad Wright / Robert C. Cooper / MGM
- **disclosure**: Stargate SG-1 'Revelations' (S5E22, 2002); 'Fragile Balance' (S7E3, 2003) shows clone-creation mechanics; 'Unending' (S10E20, 2007).
- **ip status**: fictional
- **prior art notes**: Asgard biological-transfer technology depicted as: a paired tank/pod system in which an aging consciousness is transferred to a freshly grown clone body. The 'Fragile Balance' episode shows young O'Neill's clone in a half-grown state in a fluid-filled growth chamber. Defensive prior art for: cloning-vat with consciousness-transfer interface, paired old-body / new-body transfer apparatus, and accelerated-clone growth chambers.

## Star Trek Enterprise Dr. Phlox's biological-creature pharmacopoeia (2001)

- **id**: `star-trek-ent-phlox-menagerie`
- **corpus**: fictional
- **device class**: fictional-laboratory
...
## Y: The Last Man Dr. Mann's reproductive cloning facility (2002)

- **id**: `y-last-man-sperm-bank`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Brian K. Vaughan / Pia Guerra / Vertigo
- **disclosure**: Y: The Last Man #1-60 (Vertigo/DC 2002-2008), Brian K. Vaughan & Pia Guerra.
- **ip status**: fictional
- **prior art notes**: Dr. Allison Mann's labs depict reproductive cloning research including specimen storage, gestation chambers, and reproductive-tissue cultivation. Defensive prior art for: reproductive cloning research labs combining gamete storage + cultivation + gestation chambers.
...
## John Scalzi Old Man's War CDF Greenie body conversion (consciousness transfer to engineered body) (2005)

- **id**: `scalzi-old-mans-war-cdf-greenie`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: John Scalzi
- **disclosure**: John Scalzi, Old Man's War (Tor 2005) ISBN 0-7653-0940-8; The Ghost Brigades (2006); The Last Colony (2007).
- **ip status**: fictional
- **prior art notes**: Scalzi describes the CDF (Colonial Defense Forces) consciousness-transfer procedure: aged recruit's mind is transferred to a chlorophyll-enhanced ('Greenie') engineered body grown from genetic samples. Detailed depictions of the paired-body transfer procedure, growth tanks, and post-transfer recovery. Defensive prior art for: aged-to-young consciousness-transfer pipelines, engineered-body production with chloroplast augmentation, and paired-body transfer apparatus. Plus the CDF BrainPal neural implant.

## Iron Man Extremis virus injection and recovery (2005)

- **id**: `iron-man-extremis-injection`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Warren Ellis / Adi Granov / Marvel
- **disclosure**: Iron Man: Extremis (Marvel 2005-2006), Warren Ellis & Adi Granov, Iron Man Vol. 4 #1-6; Iron Man 3 film (Marvel Studios 2013).
- **ip status**: fictional
...
- **disclosure**: BioShock (2K Games/Irrational Games 2007); BioShock 2 (2010); BioShock Infinite uses analog Lutece Cards but Vita-Chambers persist in DLC 'Burial at Sea' (2013-2014).
- **ip status**: fictional
- **prior art notes**: BioShock Vita-Chambers depicted as standalone resurrection chambers tuned to a specific player's genetic signature. Visible mechanics show: vacuum-evacuation, fluid-fill, regenerative-fluid bath, and revival sequence with bubbling/perfusion effects. Defensive prior art for: standalone resurrection-pod machinery distributed in environment, genetic-signature-tuned activation, and visible fluid-perfusion regenerative cycle. Distinct from existing BioShock plasmid entry.
...
## One-Punch Man Dr. Genus House of Evolution biological augmentation lab (2009)

- **id**: `one-punch-man-doctor-genus`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: ONE / Yusuke Murata
- **disclosure**: One-Punch Man (ONE webcomic 2009; Yusuke Murata manga 2012-present); anime (Madhouse 2015).
- **ip status**: fictional
...
- **id**: `mass-effect-cerberus-lazarus-project`
- **corpus**: fictional
- **device class**: fictional-laboratory
...
- **disclosure**: Marx, U. et al. Biology-inspired microphysiological systems to advance medicines for patient benefit and animal welfare. ALTEX 2020, 37, 365–394. DOI: 10.14573/altex.2001241
- **ip status**: public-domain
- **prior art notes**: The NIH NCATS / DARPA Tissue Chips for Drug Screening program (launched 2012) defined the regulatory and architectural framework for organ-chip-based drug development. Cited as the canonical reference for the body-on-chip / multi-organ-chip framing as a regulatory-scientific program rather than a research curiosity. Directly relevant to the FDA Modernization Act 2.0 (2022) framework for non-animal alternatives.
...
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Gen Urobuchi / Production I.G
...
## Eleventh Doctor regeneration energy restoration (The Time of the Doctor) (2013-12-25)

- **id**: `doctor-who-eleventh-doctor-regeneration-restoration`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: BBC / Steven Moffat
- **disclosure**: Doctor Who, The Time of the Doctor (BBC, broadcast 2013-12-25), written by Steven Moffat; regeneration mechanics established across the series from The Tenth Planet (BBC, 1966) onward; IMDB tt2779316.
- **ip status**: fictional
- **prior art notes**: Discloses a whole-organism restorative process: damage/aging sensed, a restorative medium flushed through the entire body to rewrite cells to a renewed state, with the capacity to externally replenish the restorative reservoir when exhausted, and the capacity to divert/partition the discharge. Anticipates generic claims to whole-body regenerative perfusion plus reservoir-replenishment plus partitionable restorative discharge. Borderline (energy, not fluid) but the perfusion-style whole-body distribution is the cited aspect; pairs with doctor-who-tardis-zero-room and Star Trek Genesis-matrix entries.
...
## Microfluidic cell culture review (2014)

- **id**: `lab-on-chip-mehling-tay-review`
- **corpus**: academic
- **device class**: organ-on-chip
- **creator**: Tay group, ETH Zurich
- **disclosure**: Mehling, M.; Tay, S. Microfluidic cell culture. Curr. Opin. Biotechnol. 2014, 25, 95–102. DOI: 10.1016/j.copbio.2013.10.005
- **ip status**: public-domain
- **prior art notes**: Concise review of microfluidic cell culture establishing the design principles that distinguish cell-culture chips from chemistry chips: surface chemistry compatibility, perfusion timescales matching biological time constants, gas exchange, and avoiding shear-induced cell stress. Cited as a methods reference for organ-on-chip work.
...
- **id**: `roosterbio-rooster-platform`
- **corpus**: private
- **device class**: single-cell-platform
- **creator**: RoosterBio Inc.
- **disclosure**: RoosterBio Inc. xeno-free MSC platform launch 2014. https://www.roosterbio.com. Patent family: US10557118B2 (RoosterBio; priority 2014).
- **ip status**: patented
- **prior art notes**: Reference reagent and seed-cell supply architecture for MSC-based regenerative medicine: fully xeno-free expansion media plus high-density frozen MSC vials, designed to plug into multi-vendor bioreactor lines. Anticipates: xeno-free chemically defined MSC media compositions and vial-based seed-cell supply formats for CGT manufacturing.
...
## Made in Abyss Curse-bearing fluid biology and Idofront laboratories (2017)

- **id**: `made-in-abyss-curse-bearing-fluid`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Akihito Tsukushi
- **disclosure**: Made in Abyss (Akihito Tsukushi, Takeshobo 2012-present); anime adaptation (Kinema Citrus 2017); Made in Abyss: Dawn of the Deep Soul film (2020).
- **ip status**: fictional
- **prior art notes**: Bondrewd's Idofront laboratory depicted as performing biological-conversion experiments on Hollows — including extensive perfusion, fluid-mixing, and cellular-recombination apparatus. Borderline; defensive prior art for experimental biological-conversion laboratories with chained perfusion + extraction + recombination subsystems. Mark draft.
...
## Star Wars Visions 'The Twins' embryonic vat (2021)

- **id**: `star-wars-visions-the-twins-vat`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Studio Trigger / Lucasfilm / Disney+
- **disclosure**: Star Wars: Visions Volume 1, 'The Twins' episode (Disney+ 2021-09-22), Studio Trigger / Lucasfilm.
- **ip status**: fictional
- **prior art notes**: The Twins opens with twin Sith children in twin amniotic vats sharing a common reagent reservoir. The vats are visually instrumented with sensors, perfusion lines, and a shared bioreactor manifold. Anticipates: paired/twin embryonic culture vats sharing a single reagent reservoir with synchronized perfusion control; multi-subject shared-reservoir architectures for genetic engineering protocols. Useful prior art for 'paired bioreactor vat with shared reagent reservoir' claims.
...
## Transporter pattern-buffer used as biological stasis (SNW: Ghosts of Illyria / Lift Us Where Suffering Cannot Reach) (2022-05-19)

- **id**: `star-trek-snw-transporter-buffer-stasis`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: CBS Studios / Akiva Goldsman, Henry Alonso Myers, Alex Kurtzman
- **disclosure**: Star Trek: Strange New Worlds, season 1 (Paramount+, premiered 2022-05-05); the buffer-stasis reveal in The Elysian Kingdom (S1E08, aired 2022-06-23) and Ghosts of Illyria (S1E03, aired 2022-05-19); precedent in Star Trek: TNG Relics (1992, Scotty in a buffer); IMDB tt12327578.
- **ip status**: fictional
- **prior art notes**: Discloses use of a dematerialized-pattern storage buffer as indefinite biological stasis, with a pattern-integrity maintenance loop and exact-state rematerialization, deployed clinically to halt a disease. Anticipates generic claims to non-metabolic stasis storage of a biological entity as a maintained data/energy pattern and to periodic-refresh integrity loops for stored biological patterns. Pairs with diaspora-polis-physiology and star-trek-tng-darwin-station-genetics-lab (clean-template restore).
