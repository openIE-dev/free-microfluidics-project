---
title: interface-luer-lock-port
parent: Cross-cuts
layout: default
---
...
## BD FACSChorus Clinical Workstation (2018)

- **id**: `bd-facschorus-clinical-software`
- **corpus**: private
- **device class**: flow-controller
- **creator**: Becton Dickinson
- **disclosure**: BD FACSChorus product launch 2018; FDA 510(k) K181891
- **ip status**: patented
- **prior art notes**: Discloses a regulatory-compliant clinical-lab interface module that constrains user interaction with a flow cytometer to template-driven workflows. Anticipates: FDA-cleared software-defined fluidic-control modules for clinical flow cytometry with per-sample audit trails.
