---
title: interface-blister-pack-reagent-storage
parent: Cross-cuts
layout: default
---
...
## 23andMe Oragene Saliva Collection Tube (2007)

- **id**: `23andme-saliva-collection-tube`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: DNA Genotek Inc. (now OraSure subsidiary) for 23andMe
...
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Ancestry.com / DNA Genotek Inc.
...
- **id**: `natera-signatera-collection-cartridge`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Natera Inc.
- **disclosure**: Natera Signatera commercial launch 2017; Reinert T et al. JAMA Oncol 5(8):1124-1131 2019 doi:10.1001/jamaoncol.2019.0528
- **ip status**: patented
- **prior art notes**: Sample collection layer for personalized MRD testing. The microfluidic-relevant primitive is the Streck cell-stabilizer tube that prevents WBC lysis releasing genomic DNA. Sister-entry to other consumer/clinical collection vessels. Anticipates: stabilizer-tube architectures for ctDNA preservation in transport.
