---
title: mixer-passive-split-recombine
parent: Cross-cuts
layout: default
---
...
- **device class**: lab-on-chip
- **creator**: Chemtrix BV
- **disclosure**: Chemtrix BV Plantrix MR product brochure 2012; Hessel, V. et al. 'Process-design intensification — direct synthesis of nitroglycerin in a microreactor', Chem. Eng. Technol. 2013, 36, 1873–1880; EP2575999A1
- **ip status**: patented
- **prior art notes**: Discloses a sintered-3C-SiC continuous-flow reactor module with internal split-and-recombine multilamination mixer, designed for direct numbering up from gram-per-minute (Labtrix S1) to kg/day (Plantrix MR260) to multi-ton/year (Plantrix MR555) keeping the channel hydraulic diameter and Reynolds-Damköhler regime invariant. Anticipates: (a) the explicit numbering-up paradigm of equal-channel-geometry across lab/pilot/production scales; (b) SiC-substrate continuous reactor as a competitor to Corning AFR G4 SiC, providing prior-art evidence that the SiC-microreactor concept was multiply realized; (c) integration of CIP/SIP-compatible interfaces with sintered ceramic flow-paths.
