---
title: interface-foil-pierce-actuation
parent: Cross-cuts
layout: default
---
...
## Color Health Genomics Sample Collection Kit (2015-04)

- **id**: `color-health-genomics-cartridge`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Color Health Inc.
- **disclosure**: Color Genomics consumer launch April 2015; product disclosures
