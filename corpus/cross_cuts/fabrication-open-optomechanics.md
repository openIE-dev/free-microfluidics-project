---
title: fabrication-open-optomechanics
parent: Cross-cuts
layout: default
---

# Cross-cut: `fabrication-open-optomechanics`
...
## OpenRAMAN Starter Edition (2023)

- **id**: `openraman-starter-edition-2023`
- **corpus**: open
- **device class**: flow-controller
- **creator**: Luc Cogniaux
- **disclosure**: Cogniaux L. OpenRAMAN — Starter Edition. https://www.open-raman.org/build/starter (introduced 2023 as a lower-cost variant of the Performance Edition)
- **ip status**: open-permissive
- **prior art notes**: DRAFT — extends the main OpenRAMAN entry with the 'starter edition' variant. Element-by-element discloses a simplified Czerny-Turner Raman bench for educational use with cuvette-based liquid sampling. Strengthening work: capture release date precisely and any companion peer-reviewed publication.
