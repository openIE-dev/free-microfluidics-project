...
## Stanisław Lem The Cyberiad — Trurl's matter-compiler machines (1965)

- **id**: `lem-cyberiad-matter-compiler`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Stanisław Lem
- **disclosure**: Stanisław Lem, Cyberiada (Wydawnictwo Literackie 1965); English: The Cyberiad (Seabury 1974) ISBN 0-8164-9231-6.
- **ip status**: fictional
- **prior art notes**: Lem's Cyberiad depicts Trurl's universal-constructor machines that synthesize arbitrary matter from raw inputs through chained chemical-and-mechanical operations. Defensive prior art (1965) for: programmable matter-synthesis machines, chained chemical-formulation pipelines, and universal-fab architectures. Strong cumulative-fiction anchor.
...
## Infors HT Multitron Incubator Shaker (Cell / Pro) (2000)

- **id**: `infors-multitron-cell-incubator-shaker`
- **corpus**: private
...
- **disclosure**: Halo: The Fall of Reach (Eric Nylund, Del Rey 2001); Halo: First Strike (2003).
- **ip status**: fictional
- **prior art notes**: Underground ONI augmentation/research facility on Reach. Lore details include: dedicated augmentation suites, ICU recovery vats, cell-culture and tissue-engineering labs, and reagent-synthesis facilities. Defensive prior art for an integrated military-grade augmentation hospital combining surgical bays, recovery perfusion stations, and on-site reagent synthesis. Anticipates 'augmentation-as-a-service' facility architecture combining multi-step fluid handling, diagnostics, and recovery.
...
## Peter F. Hamilton Memorycell neural-backup implant (Commonwealth Saga) (2004)

- **id**: `hamilton-memorycell-neural-backup`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Peter F. Hamilton
- **disclosure**: Peter F. Hamilton, Pandora's Star (Macmillan UK 2004) ISBN 0-333-90994-2; Judas Unchained (2005).
- **ip status**: fictional
- **prior art notes**: The Commonwealth Saga's memorycell is an implanted neural-backup module that continuously samples the host's neural state. On host death, the cell is recovered and used to template a regrown clone body in a re-life clinic. Hamilton describes the recovery and restoration pipeline in extensive engineering detail across two ~1000-page novels. Architecturally anticipates: implanted continuous brain-state recording + secure-storage + body-recovery + clone-installation as a complete pipeline. Defensive prior art for: implanted neural-recording devices with persistent memory, post-mortem neural-data extraction, and clone-and-restore service architectures.
...
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: 343 Industries / Karen Traviss
...
## Control (Remedy) Service Weapons fluidic-Hiss containment (2019)

- **id**: `control-game-service-weapons`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: Remedy Entertainment
- **disclosure**: Control (Remedy Entertainment/505 Games 2019).
- **ip status**: fictional
- **prior art notes**: FBC research-bay equipment depicted with bio-fluidic containment chambers for Hiss-affected biological samples. Defensive prior art for hostile-biological-sample containment with active fluidic perfusion. Mark draft due to limited engineering specificity.
