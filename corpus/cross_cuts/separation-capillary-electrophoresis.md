---
title: separation-capillary-electrophoresis
parent: Cross-cuts
layout: default
---
...
## On-chip electrokinetic injection patent (Manz / Ciba-Geigy 1993) (1993)

- **id**: `manz-1993-on-chip-injection-patent`
- **corpus**: academic
- **device class**: lab-on-chip
- **creator**: Manz / Widmer (Ciba-Geigy AG)
- **disclosure**: Manz, A. et al. EP0653206 / US5500071: Method of injecting samples in chip-format CE using electrokinetic gating. Filed 1993, granted 1996.
- **ip status**: patented
...
- **disclosure**: Trinity Biotech Premier Hb9210. https://www.trinitybiotech.com
- **ip status**: patented
- **prior art notes**: HPLC-based hemoglobin A1c (HbA1c) analyzer with integrated microfluidic-equivalent column and sample handling. The HbA1c-by-HPLC product category is a major clinical lab segment for diabetes monitoring; Trinity Biotech, Bio-Rad Variant, and Tosoh G7/G8/G11 all compete in this space. Reference for the broader HbA1c cartridge market.
