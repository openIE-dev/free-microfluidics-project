---
title: fabrication-thermoplastic-injection-molding
parent: Cross-cuts
layout: default
---
...
- **disclosure**: microfluidic ChipShop GmbH product catalog. https://www.microfluidic-chipshop.com
...
- **disclosure**: Beckman Coulter AU/DxC analyzer family. https://www.beckmancoulter.com
- **ip status**: patented
- **prior art notes**: Major central-lab clinical chemistry analyzer platform. Cousin of Roche cobas c series in product positioning. The Beckman Coulter portfolio (acquired by Danaher 2011) includes diverse microfluidic-equivalent analytical cartridges from the 1990s onward — the cumulative patent estate is among the largest in the central-lab clinical chemistry space.

## Abbott ARCHITECT i2000/i2000SR immunoassay analyzer cartridge (2003)
...
## Zoetis Vetscan IMAGYST AI-augmented veterinary diagnostics (2020)

- **id**: `zoetis-vetscan-imagyst`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Zoetis Inc.
- **disclosure**: Zoetis Vetscan IMAGYST. https://www.zoetisus.com
- **ip status**: patented
