---
title: fabrication-paper-microfluidics
parent: Cross-cuts
layout: default
---
...
- **disclosure**: 3M Petrifilm (acquired by Neogen 2022). Various FDA / AOAC approvals.
- **ip status**: patented
...
- **disclosure**: OraSure Technologies OraQuick rapid HIV-1/2 antibody test. FDA approval 2002 (in-vitro use), 2012 (over-the-counter). https://www.orasure.com
- **ip status**: patented
- **prior art notes**: Lateral flow immunoassay cartridge — the architectural ancestor of all subsequent rapid antigen tests including pregnancy tests, COVID rapid antigen, and dozens of others. Anticipates: nitrocellulose lateral-flow membrane format, capillary-driven assay with conjugate pad and capture line, and the entire commercial point-of-care antigen-test product category.

## IDEXX SNAP veterinary lateral-flow cartridge family (1995)

- **id**: `idexx-snap-veterinary`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: IDEXX Laboratories
- **disclosure**: IDEXX Laboratories SNAP product family. https://www.idexx.com
- **ip status**: patented
...
## Abbott BinaxNOW rapid antigen test cassette (1996)
...
- **device class**: point-of-care-cartridge
- **creator**: Whitesides group, Harvard
- **disclosure**: Carrilho, E.; Martinez, A. W.; Whitesides, G. M. Understanding wax printing: a simple micropatterning process for paper-based microfluidics. Anal. Chem. 2009, 81, 7091–7095. DOI: 10.1021/ac901071p
- **ip status**: public-domain
- **prior art notes**: Disclosed wax printing as a sub-$0.10/device fabrication path for paper microfluidics: a commodity solid-ink printer deposits wax patterns that, after melting, reflow vertically through paper to create hydrophobic barriers defining channels. Anticipates: wax-as-hydrophobic-barrier as a paper microfluidic fabrication primitive, low-cost disposable diagnostic manufacturing without specialized equipment, and the entire post-2009 paper-microfluidic literature.

## ChemBio Diagnostics DPP (Dual Path Platform) lateral-flow (2009)

- **id**: `chembio-dpp`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: ChemBio Diagnostic Systems
- **disclosure**: ChemBio Diagnostic Systems DPP product family. https://chembio.com
- **ip status**: patented
...
- **disclosure**: BD Veritor System product family. https://www.bd.com
- **ip status**: patented
- **prior art notes**: Lateral-flow antigen cartridge architecturally similar to BinaxNOW, with reflectance-readout instrument distinguishing positive lines below visible-detection threshold. Anticipates: instrument-read lateral-flow as a hybrid between purely visual rapid antigen tests and full molecular diagnostic instruments.
...
## BD Veritor rapid test platform (2011)

- **id**: `bd-veritor-rapid-test`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Becton Dickinson
- **disclosure**: Becton Dickinson BD Veritor System. https://www.bd.com
- **ip status**: patented
...
- **disclosure**: QuidelOrtho Sofia 2 Fluorescent Immunoassay Analyzer. https://www.quidelortho.com
- **ip status**: patented
- **prior art notes**: Cartridge-based fluorescent lateral-flow immunoassay platform: standard LFA strip with fluorescent (rather than colorimetric) labels and benchtop fluorescence reader. Architectural cousin of BD Veritor with fluorescent rather than visible-light readout, offering improved sensitivity. Major POC respiratory infection test platform.

## Manylabs.org Citizen Science Hardware Platform (2014)

- **id**: `manylabs-citizen-science-platform`
- **corpus**: open
- **device class**: other
- **creator**: Manylabs (Peter Sand et al., San Francisco)
- **disclosure**: Manylabs.org launched 2014 by Peter Sand; https://www.manylabs.org; profiled in Public Lab community archives and documented in Sand 2016 IEEE Pervasive Computing column
- **ip status**: open-permissive
- **prior art notes**: Discloses an open citizen-science data-and-hardware platform whose published environmental-sensor designs include several paper-microfluidic colorimetric assays (nitrate, phosphate, pH) packaged with smartphone-based readout. Relevance to commons: prior art for 'low-cost paper-microfluidic environmental water-quality sensor with smartphone readout' as of 2014-2016, including open lesson-plan and protocol documentation.
...
- **id**: `letsgetchecked-home-collection`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: LetsGetChecked Ltd.
- **disclosure**: LetsGetChecked Ltd. product launch 2015 (Dublin); company disclosures
- **ip status**: trade-secret
- **prior art notes**: Sister entry to Everlywell. Capillary-blood collection on DBS-style absorbent cards or microcontainers. Anticipates: same consumer DBS workflow and shipped-sample architecture.

## Everlywell At-Home Sample Collection Kit (2015-11)

- **id**: `everlywell-home-collection-kit`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: Everly Health Inc. (Everlywell)
...
## SD Biosensor STANDARD Q rapid antigen test (2017)

- **id**: `sd-biosensor-rapid-antigen`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: SD Biosensor (Korea)
- **disclosure**: SD Biosensor STANDARD Q product family. https://sdbiosensor.com
- **ip status**: patented
...
## SHINE CRISPR-on-paper diagnostic (2018)
