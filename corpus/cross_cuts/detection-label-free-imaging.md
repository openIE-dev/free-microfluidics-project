---
title: detection-label-free-imaging
parent: Cross-cuts
layout: default
---
...
## A. Bertram Chandler - Rim Runner autodoc (1961)

- **id**: `chandler-rim-runner-autodoc`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: A. Bertram Chandler
- **disclosure**: Chandler A.B., 'The Rim of Space' Avalon 1961
- **ip status**: fictional
...
## Roper Industries / Roper Technologies microfluidic patent family (2005)

- **id**: `roper-industries-microfluidic-patent-family`
- **corpus**: private
- **device class**: flow-controller
- **creator**: Roper Technologies
- **disclosure**: Roper Industries / Roper Technologies precision-measurement IP estate; US filings 2005-present
- **ip status**: patented
- **prior art notes**: Roper Industries patent family covers precision-measurement fluidic flow controllers and process-analytical fluidic IP. Anticipates claims directed to industrial process-analytical fluidic cartridges with precision-measurement readout.
...
## Hitachi Aloka ultrasound-fluidic patent family (2010)

- **id**: `hitachi-aloka-ultrasound-fluidic-patents`
- **corpus**: private
- **device class**: other
- **creator**: Hitachi Aloka Medical Ltd
- **disclosure**: Hitachi Aloka Medical (merged 2011) ultrasound fluidic patents; JP/US filings 1990s-present
- **ip status**: patented
- **prior art notes**: Hitachi Aloka patent family covers ultrasound-coupled fluidic-irrigation/biopsy-channel systems. Anticipates claims directed to ultrasound-guided biopsy cartridges with integrated fluidic specimen retrieval.
...
## WAIS Divide ice core - high-resolution Antarctic Holocene (2013)

- **id**: `wais-divide-ice-core`
- **corpus**: academic
- **device class**: lab-on-chip
- **creator**: WAIS Divide Ice Core Project (US NSF)
- **disclosure**: WAIS Divide Project Members, Onset of deglacial warming in West Antarctica driven by local orbital forcing, Nature 500 (2013) 440-444.
- **ip status**: public-domain
- **prior art notes**: Discloses high-resolution CFA microfluidic train for ice-core gas chemistry. Anticipates sub-annual-resolution microfluidic CFA paleo-climate gas chemistry claims.
...
## OpenMV Cam Open-Source Machine Vision Module (2014)

- **id**: `openmv-machine-vision-cam`
- **corpus**: open
- **device class**: other
- **creator**: OpenMV LLC (Ibrahim Abdelkader)
- **disclosure**: Abdelkader I. (OpenMV LLC), Kickstarter campaign 'OpenMV — Python Powered Machine Vision' (May 2014); https://openmv.io; https://github.com/openmv/openmv (initial commit 2014)
- **ip status**: open-permissive
- **prior art notes**: Discloses a low-cost (~$80) MicroPython-programmable smart camera module (STM32H7 + OV5640/MT9V034 sensors) that runs computer-vision primitives (blob detection, frame differencing, optical flow, ML inference) directly on the camera MCU and publishes results via UART/I2C. Its relevance to microfluidics is as the reference embedded-vision module used in many open microfluidic monitors: droplet counters, colony counters, on-chip cell-counting stations, and Pioreactor-style optical density backups. Anticipates: any patent claim to 'a low-cost embedded MicroPython smart camera tightly coupled to a microfluidic device for closed-loop monitoring' as of 2014; specifically the architectural pattern of running cv2/ML inference at the sensor edge and feeding count/decision events to a host controller over serial.

## Cytena C.SIGHT and B.SIGHT single-cell printers (2014)

- **id**: `cytena-csight-bsight`
- **corpus**: private
- **device class**: dispenser-pipettor
- **creator**: Cytena (Cellink Group, BICO)
- **disclosure**: Gross, A. et al. Single-cell printer: automated, on demand, and label free. J. Lab. Autom. 2013, 18, 504-518. DOI: 10.1177/2211068213497204. Cytena spun out of IMTEK Freiburg 2014; acquired by Cellink 2019.
- **ip status**: patented
- **prior art notes**: Image-feedback piezo dispenser that ejects single droplets from a glass cartridge while imaging the nozzle exit; only droplets imaged to contain exactly one cell are dispensed into the target well. Anticipates: image-verified-then-deposit single-cell dispensing as an alternative to FACS-sort or microwell deposition; the 'piezo dispenser + camera + glass cartridge' architectural pattern. Foundational to many cell-line development workflows requiring documented monoclonality.
...
## JEOL JNM-ECZL NMR fluidic patent family (2017)

- **id**: `jeol-jnm-eczl-nmr-patent-family`
- **corpus**: private
- **device class**: flow-controller
- **creator**: JEOL Ltd
- **disclosure**: JEOL JNM-ECZL series launch (2017); JP/US filings
- **ip status**: patented
- **prior art notes**: JEOL JNM-ECZL patent family covers sub-mL flow-NMR sample cartridge with autosampler fluidic delivery. Anticipates claims directed to flow-NMR fluidic cartridge designs with magnet-bore-coupled delivery.

## Aiforia AI-pathology platform - Cloud H&E whole-slide analysis (2017)

- **id**: `aiforia-ai-pathology-platform`
- **corpus**: private
- **device class**: other
- **creator**: Aiforia Technologies Plc
...
## Owkin federated multimodal AI biomarker platform (2018)

- **id**: `owkin-biotech-multimodal-ai`
- **corpus**: private
- **device class**: other
- **creator**: Owkin Inc.
- **disclosure**: Owkin federated learning platform Substra published 2018; Sanofi strategic partnership 2021.
- **ip status**: open-permissive
...
## AOAC SMPR 2019.001 - Cannabis potency standardization method (2019)

- **id**: `aoac-smpr-2019-cannabis-method`
- **corpus**: academic
- **device class**: other
- **creator**: AOAC International Cannabis Analytical Science Program
- **disclosure**: AOAC INTERNATIONAL SMPR 2019.001 - Quantitation of Cannabinoids in Cannabis Dried Plant Materials, Concentrates, and Oils. J. AOAC Int. 102 (2019) 1602-1605.
- **ip status**: public-domain
- **prior art notes**: Discloses standardized cannabis potency quantitation HPLC method performance criteria adopted by 30+ state cannabis programs. Anticipates regulatory HPLC cannabis potency standardization workflow claims.

## Foss SpiritScan distilled-spirits NIR analyzer (2019)

- **id**: `foss-spiritscan-distilled-qc`
- **corpus**: private
- **device class**: lab-on-chip
...
- **id**: `rockley-photonics-bioptx-multianalyte`
- **corpus**: private
- **device class**: other
- **creator**: Rockley Photonics Holdings Ltd.
- **disclosure**: Rockley Photonics S-1 / SEC filings 2021; company technology disclosure 2021-08-31; patent family WO2020041467
- **ip status**: patented
- **prior art notes**: Borderline scope inclusion: not a fluid-handling device, but interrogates microliter-scale interstitial-fluid volumes via SWIR spectroscopy through a tight skin window. Included for completeness of the wearable-biosensor neighborhood; useful as a non-microfluidic comparator entry. Anticipates: SWIR-photonic non-invasive multi-analyte wrist wearables (which is the architectural alternative to microfluidic sweat patches).
