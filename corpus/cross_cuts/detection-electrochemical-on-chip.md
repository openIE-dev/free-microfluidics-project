---
title: detection-electrochemical-on-chip
parent: Cross-cuts
layout: default
---
...
- **disclosure**: Clarke, J.; Wu, H.-C.; Jayasinghe, L.; Patel, A.; Reid, S.; Bayley, H. Continuous base identification for single-molecule nanopore DNA sequencing. Nat. Nanotechnol. 2009, 4, 265–270. DOI: 10.1038/nnano.2009.12
- **ip status**: patented
...
## Oxford Nanopore MinION flow cell (2014)

- **id**: `oxford-nanopore-minion`
- **corpus**: private
- **device class**: lab-on-chip
- **creator**: Oxford Nanopore Technologies
- **disclosure**: Oxford Nanopore Technologies MinION flow cell. https://nanoporetech.com
- **ip status**: patented
- **prior art notes**: USB-form-factor cartridge containing a microfluidic channel with an array of 512 protein nanopores, each with integrated current-sense electronics. The smallest commercially-deployed sequencing form factor. Anticipates: handheld microfluidic sequencing cartridge, USB-powered sequencing instrument, and the field-deployable sequencing application class. Direct commercial descendant of Bayley/Clarke 2009.
...
## Iontophoretic / reverse iontophoretic sampling on skin (Heikenfeld lineage) (2014)

- **id**: `kim-rogers-iontophoresis-skin-2014`
- **corpus**: academic
- **device class**: point-of-care-cartridge
- **creator**: Heikenfeld group, Cincinnati
- **disclosure**: Heikenfeld, J. Non-invasive analyte access and sensing through eccrine sweat: challenges and outlook circa 2016. Electroanalysis 2016, 28, 1242–1249. DOI: 10.1002/elan.201600018
- **ip status**: patented
- **prior art notes**: Heikenfeld-group framing of skin-interfacing microfluidic biosensors: iontophoretic sweat induction, capillary collection, electrochemical analysis. Reference for the architectural family of stimulus-evoked-sample wearable biosensors that compete with passive-collection (Rogers) approaches.

## MC10 BioStamp wearable physiological sensor (2014)

- **id**: `mc10-biostamp`
- **corpus**: private
- **device class**: point-of-care-cartridge
- **creator**: MC10 Inc. (assets acquired by Medidata 2020)
- **disclosure**: MC10 Inc. BioStamp Research Connect platform. Patent family includes US9159635B2.
- **ip status**: patented
