---
title: cell-trap-microwell-array
parent: Cross-cuts
layout: default
---
...
## Cyfuse Biomedical Regenova Kenzan-method bioprinter (2010)

- **id**: `cyfuse-regenova`
- **corpus**: private
- **device class**: printer-tooling
- **creator**: Cyfuse Biomedical K.K.
- **disclosure**: Itoh, M. et al. Scaffold-free tubular tissues created by a Bio-3D printer undergo remodeling and endothelialization when implanted in rat aortae. PLoS ONE 2015, 10(9):e0136681. doi:10.1371/journal.pone.0136681. Cyfuse Biomedical K.K. founded 2010 (Saga University spinout). Regenova commercialized 2013. Patent family: US9764513B2 (Saga University / Cyfuse; priority 2010).
- **ip status**: patented
- **prior art notes**: Discloses a scaffold-free bioprinting modality (Kenzan method) in which pre-formed cell spheroids are robotically skewered onto a fine-needle array, allowed to fuse into tissue over days, then released by withdrawing the needles. Architecturally distinct from extrusion-, inkjet-, and volumetric-bioprinting families because no biomaterial bioink is used. Anticipates: (a) scaffold-free spheroid-skewering bioprinting as a category; (b) needle-array-as-temporary-scaffold construct geometry; (c) spheroid-fusion-based tissue-engineered nerve and vascular grafts as a clinical product class.
...
## Halo Forerunner Composer mass-state-conversion array (fluidic interpretation) (2012)

- **id**: `halo-forerunner-composer-fluidic`
- **corpus**: fictional
- **device class**: fictional-laboratory
- **creator**: 343 Industries / Greg Bear
- **disclosure**: Halo 4 (343 Industries, 2012); Halo: Silentium (Greg Bear, Tor 2013) ISBN 978-0-7653-3304-4.
- **ip status**: fictional
- **prior art notes**: Borderline — primarily depicted as exotic-state digitization, but Halo: Silentium (Bear) describes Forerunner Composer-related medical research as drawing physical brain matter through cellular-scale capture chambers, requiring elaborate liquid perfusion and sample-extraction handling. Cited here for completeness; modest fictional prior art for cellular-resolution brain-tissue perfusion + readout coupled systems. Mark draft due to thin fluid-handling specifics.
